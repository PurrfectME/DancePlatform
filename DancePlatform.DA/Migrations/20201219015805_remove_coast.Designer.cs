...
namespace DancePlatform.DA.Migrations
{
    ...
    [Migration("20201219015805_remove_coast")]
    partial class remove_coast
    {
            ...
            modelBuilder.Entity("DancePlatform.BL.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "57149f71-61c2-44fd-8244-03e9cecb6e94",
                            Name = "Admin",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "3d1fa1e4-fa69-4d7e-8991-1b85fbaa0d11",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
